...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 min-h-screen fade-in" style="margin-top: 80px;">
    <div class="mb-8">
        <h1 class="text-4xl md:text-5xl font-serif text-white mb-4">Nawoord</h1>
    ...
    <div class="prose prose-invert max-w-none">
        <div class="bg-neutral-900 border border-white/5 rounded-2xl p-8 mb-8">
            <p class="text-gray-300 text-lg leading-relaxed mb-6">
                Het maken van dit portfolio is een intensieve maar zeer leerzame ervaring geweest. Elke fotografiesessie bracht nieuwe uitdagingen en inzichten met zich mee, van het beheersen van licht in de studio tot het vangen van het juiste moment bij bewegingsfotografie.
            </p>
            
            <h2 class="text-2xl font-serif text-brand-accent mb-4 mt-8">Wat ik heb geleerd</h2>
            ...
            <div class="mt-8 pt-6 border-t border-white/10">
                <p class="text-brand-accent font-serif text-xl">Arne Meevis</p>
                <p class="text-gray-500 text-sm">Januari 2026</p>
            </div>
        </div>
        
        <div class="text-center">
            <a href="/" class="inline-flex items-center text-brand-accent hover:text-white transition-colors">
                Terug naar homepage
